...
public class TestHalfEdgeMesh {
	...
	public static void main(String[] argv)
	{
		...
		osu.halfEdgeMesh.HalfEdgeMeshA mesh = new osu.halfEdgeMesh.HalfEdgeMeshA();
		osu.halfEdgeMesh.OffFileReaderA file_reader = new osu.halfEdgeMesh.OffFileReaderA();
		osu.halfEdgeMesh.OffFileWriterA file_writer = new osu.halfEdgeMesh.OffFileWriterA();
		...
		try {
			...
			osu.halfEdgeMesh.ErrorInfo error_info = mesh.CheckAll();
	...
	static boolean warn_non_manifold_or_not_oriented(osu.halfEdgeMesh.HalfEdgeMeshA mesh)
	{
		osu.halfEdgeMesh.ManifoldInfo manifold_info = mesh.CheckManifold();
		...
		if (!manifold_info.FlagManifold()) {
			...
			osu.halfEdgeMesh.OrientationInfo orientation_info = mesh.CheckOrientation();
